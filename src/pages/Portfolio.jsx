...
{/* ----------ecommarce page */}
  ...
  <div data-aos="fade-left" className="bg-[#161616] h-[280px] px-[20px] pt-[20px] max-md:w-full max-md:h-auto max-md:pb-[20px]">
    ...
    <p className="text-[16px] font-normal font-main text-[#9F9F9F]">this is REACT.js e-commmarce website when using react.js tailwind css , vilina javascript , npm plugin or packges , responsive design.</p> </div>
